  ...
  return (
    <div
      className="before:content-[''] after:content-[''] before:absolute after:absolute  
        ...
        md:before:w-[22.125rem] before:w-[17.125rem] 
        md:after:w-[22.125rem] after:w-[17.125rem] 
        after:h-[17.125rem] md:after:h-[22.125rem] 
        before:h-[17.125rem] md:before:h-[22.125rem] 
        before:bg-[#7e61e7] after:bg-[#7e61e7] 
        before:blur-[225px] after:blur-[225px] 
        before:-top-12 before:-left-20 
        after:-bottom-25 after:right-0 -z-10"
    ></div>
  );
};
