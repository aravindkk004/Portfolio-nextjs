export const projects = [
  {
    ...
    image: "./images/mock-master-ui.png",
    source_code_link:
  ...
  },
  {
    ...
    tags: [
      { name: "EJS", color: "#56ccf2" },
      { name: "Express JS", color: "#11998e" },
      { name: "PostgreSQL", color: "#ec008c" },
    ],
    image: "./images/talencrafter.png",
  ...
  },
  {
    ...
    tags: [
      { name: "HTML", color: "#56ccf2" },
      { name: "CSS", color: "#11998e" },
      { name: "JS", color: "#ec008c" },
    ],
